歡迎來玩玩看 --> [gogogo 點開就可以用了不過要等一下](https://網址)
...
- 會產出一個 API Key 按下複製後
 ...
 - 建議可以貼在暫存區（電腦便利貼、備忘錄.等）
 - 貼圖測試![image](https://github.com/mfumien/net_learnin/blob/main/02pra_playoutput/%E6%88%AA%E5%9C%96%202025-04-14%2022.44.39.png)
